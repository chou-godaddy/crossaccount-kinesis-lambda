...
require (
	...
	github.com/gdcorp-domains/fulfillment-go-api v1.0.69
	github.com/gdcorp-domains/fulfillment-golang-httpclient v1.0.76
...
require (
	...
	github.com/gdcorp-domains/fulfillment-golang-middleware v1.0.53 // indirect
